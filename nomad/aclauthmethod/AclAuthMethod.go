...
import (
	...
	"github.com/cdktf/cdktf-provider-nomad-go/nomad/v8/aclauthmethod/internal"
...
func (j *jsiiProxy_AclAuthMethod) Config() AclAuthMethodConfigAOutputReference {
	var returns AclAuthMethodConfigAOutputReference
	_jsii_.Get(
		j,
		"config",
		&returns,
...
func (j *jsiiProxy_AclAuthMethod) ConfigInput() *AclAuthMethodConfigA {
...
func (j *jsiiProxy_AclAuthMethod) Default() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"default",
...
func (j *jsiiProxy_AclAuthMethod) DefaultInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"defaultInput",
...
func (j *jsiiProxy_AclAuthMethod)SetDefault(val interface{}) {
...
func (a *jsiiProxy_AclAuthMethod) PutConfig(value *AclAuthMethodConfigA) {
...
func (a *jsiiProxy_AclAuthMethod) ResetDefault() {
	_jsii_.InvokeVoid(
		a,
		"resetDefault",
		nil, // no parameters
