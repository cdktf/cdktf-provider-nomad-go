...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTokenNameFormat", GoMethod: "ResetTokenNameFormat"},
			...
			_jsii_.MemberProperty{JsiiProperty: "tokenNameFormat", GoGetter: "TokenNameFormat"},
			_jsii_.MemberProperty{JsiiProperty: "tokenNameFormatInput", GoGetter: "TokenNameFormatInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "oidcDisableUserinfo", GoGetter: "OidcDisableUserinfo"},
			_jsii_.MemberProperty{JsiiProperty: "oidcDisableUserinfoInput", GoGetter: "OidcDisableUserinfoInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetOidcDisableUserinfo", GoMethod: "ResetOidcDisableUserinfo"},
