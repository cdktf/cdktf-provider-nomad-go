...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-nomad.aclToken.AclToken",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "expirationTtlInput", GoGetter: "ExpirationTtlInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetExpirationTtl", GoMethod: "ResetExpirationTtl"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-nomad.aclToken.AclTokenConfig",
		reflect.TypeOf((*AclTokenConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-nomad.aclToken.AclTokenRole",
		reflect.TypeOf((*AclTokenRole)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-nomad.aclToken.AclTokenRoleList",
		reflect.TypeOf((*AclTokenRoleList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AclTokenRoleOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
