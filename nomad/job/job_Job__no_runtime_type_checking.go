...
func (j *jsiiProxy_Job) validatePutHcl2Parameters(value *JobHcl2) error {
	return nil
}
...
func (j *jsiiProxy_Job) validateSetConsulTokenParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_Job) validateSetDeregisterOnDestroyParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_Job) validateSetDeregisterOnIdChangeParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_Job) validateSetDetachParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_Job) validateSetJobspecParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_Job) validateSetJsonParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_Job) validateSetPolicyOverrideParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_Job) validateSetVaultTokenParameters(val *string) error {
	return nil
}
