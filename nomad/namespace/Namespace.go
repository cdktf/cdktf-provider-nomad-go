...
import (
	...
	"github.com/cdktf/cdktf-provider-nomad-go/nomad/v4/namespace/internal"
...
func (j *jsiiProxy_Namespace) Quota() *string {
	var returns *string
	_jsii_.Get(
		j,
		"quota",
...
func (j *jsiiProxy_Namespace) QuotaInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"quotaInput",
...
func (j *jsiiProxy_Namespace)SetQuota(val *string) {
...
func (n *jsiiProxy_Namespace) ResetQuota() {
	_jsii_.InvokeVoid(
		n,
		"resetQuota",
		nil, // no parameters
