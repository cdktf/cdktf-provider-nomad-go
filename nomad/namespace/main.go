...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-nomad.namespace.Namespace",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-nomad.namespace.NamespaceCapabilities",
		reflect.TypeOf((*NamespaceCapabilities)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-nomad.namespace.NamespaceCapabilitiesOutputReference",
		reflect.TypeOf((*NamespaceCapabilitiesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "disabledTaskDriversInput", GoGetter: "DisabledTaskDriversInput"},
			_jsii_.MemberProperty{JsiiProperty: "enabledTaskDrivers", GoGetter: "EnabledTaskDrivers"},
			_jsii_.MemberProperty{JsiiProperty: "enabledTaskDriversInput", GoGetter: "EnabledTaskDriversInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetDisabledTaskDrivers", GoMethod: "ResetDisabledTaskDrivers"},
			_jsii_.MemberMethod{JsiiMethod: "resetEnabledTaskDrivers", GoMethod: "ResetEnabledTaskDrivers"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-nomad.namespace.NamespaceConfig",
		reflect.TypeOf((*NamespaceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-nomad.namespace.NamespaceNodePoolConfig",
		reflect.TypeOf((*NamespaceNodePoolConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-nomad.namespace.NamespaceNodePoolConfigOutputReference",
		reflect.TypeOf((*NamespaceNodePoolConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "deniedInput", GoGetter: "DeniedInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDenied", GoMethod: "ResetDenied"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
