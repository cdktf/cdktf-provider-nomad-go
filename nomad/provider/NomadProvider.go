...
import (
	...
	"github.com/cdktf/cdktf-provider-nomad-go/nomad/v9/provider/internal"
...
func (n *jsiiProxy_NomadProvider) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (n *jsiiProxy_NomadProvider) ToHclTerraform() interface{} {
	var returns interface{}
