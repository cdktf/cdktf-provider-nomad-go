...
func (s *jsiiProxy_SchedulerConfig) validateMoveFromIdParameters(id *string) error {
	return nil
}
...
func (s *jsiiProxy_SchedulerConfig) validateMoveToIdParameters(id *string) error {
	return nil
}
